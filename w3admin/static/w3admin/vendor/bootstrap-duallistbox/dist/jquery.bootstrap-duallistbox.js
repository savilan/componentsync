...
;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoTextFiltered: '<span class="label label-primary">Filtered</span> {0} from {1}', // when not all of the options are visible due to the filter
  ...
  BootstrapDualListbox.prototype = {
    ...
    setBootstrap2Compatible: function(value, refresh) {
      ...
      if (value) {
        ...
        this.container.find('.moveall > i, .move > i').removeClass('fa-solid fa-angle-right').addClass('icon-arrow-right');
        this.container.find('.removeall > i, .remove > i').removeClass('fa-solid fa-angle-left').addClass('icon-arrow-left');
      } else {
        ...
        this.container.find('.moveall > i, .move > i').removeClass('icon-arrow-right').addClass('fa fa-solid fa-angle-right font-w900 fs-4 text-black');
        this.container.find('.removeall > i, .remove > i').removeClass('icon-arrow-left').addClass('fa fa-solid fa-angle-left font-w900 fs-4 text-black');
      }
      if (refresh) {
        refreshSelects(this);
      }
